      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            Creative Cliques & Frequent Collaborator Clusters
          </h1>
        </div>
        <p className="text-xs sm:text-sm text-white/60 mt-1">
          Graph co-occurrence pattern matching identifying auteur-actor ensembles with high artistic affinity.
        </p>
      </div>
          ...
          {cliques.map((c, idx) => (
            ...
            >
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {c.movies.map((m) => (
                      <Link
                        key={m.id}
                        href={`/graph?nodeId=${m.id}&name=${encodeURIComponent(m.title)}&type=Movie`}
              ...
              >
                ...
                <span>Explore Creative Subgraph</span>
